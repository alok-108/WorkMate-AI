                            ...
                            <div style={{
                                ...
                                {isLive && (
                                    <motion.span
                                        ...
                                        style={{ display: 'inline-block', width: 2, height: '1em', backgroundColor: 'var(--color-text-tertiary)', marginLeft: 2, verticalAlign: 'text-bottom' }}
                                    />
                                )}
                            </div>
                        </div>
                    ...
                    <g key={i}>
                        ...
                        {i > 0 && (
                            <line
                                x1={i === 1 ? 12 : 25} y1="6"
                                x2={i === 1 ? 13 : 26} y2="6"
                                stroke={filled ? 'currentColor' : 'var(--color-border)'}
                                strokeWidth="1.5"
    ...
    return (
        <div style={{ marginBottom: 4 }}>
            ...
            >
                ...
                <span style={{ fontSize: 11, fontWeight: 700, color: 'var(--color-text-tertiary)', textTransform: 'uppercase', letterSpacing: '0.07em', flex: 1, textAlign: 'left' }}>
                    {label}
                </span>
                {badge !== undefined && (
                    <span style={{ fontSize: 10, color: 'var(--color-text-tertiary)', backgroundColor: 'var(--color-bg-subtle)', padding: '1px 6px', borderRadius: 4, fontWeight: 600 }}>{badge}</span>
                )}
                <motion.span
                ...
                >
                    ...
                    <div style={{ flex: 1, overflowY: 'auto', padding: '16px 20px' }}>
                        ...
                        >
                            {thought ? (
                                <div style={{
                                    fontSize: 12.5, lineHeight: 1.75, color: 'var(--color-text-tertiary)',
                                    fontStyle: 'italic',
                                    borderLeft: '2px solid var(--color-border)',
                                    paddingLeft: 12,
                                    ...
                                    {isLive && (
                                        <motion.span
                                            animate={{ opacity: [1, 0] }}
                                            transition={{ repeat: Infinity, duration: 0.7, ease: 'linear' }}
                                            style={{ display: 'inline-block', width: 2, height: '0.9em', backgroundColor: 'var(--color-text-tertiary)', marginLeft: 2, verticalAlign: 'text-bottom' }}
                                        />
                                    )}
                                </div>
                            ) : (
                                <span style={{ fontSize: 12, color: 'var(--color-border)', fontStyle: 'italic' }}>
                        ...
                        >
                            {toolCalls.length === 0 ? (
                                <span style={{ fontSize: 12, color: 'var(--color-border)', fontStyle: 'italic' }}>No tools called yet</span>
                            ) : (
                                    ...
                                    {context.filesModified.length > 0 && (
                                        <div>
                                            ...
                                            {context.filesModified.map((file, i) => (
                                                <div key={i} style={{ fontSize: 11, color: 'var(--color-text-tertiary)', fontFamily: "'JetBrains Mono', monospace", marginBottom: 2 }}>{file}</div>
                                            ))}
                                        </div>
                                    )}
                                </div>
